                      ...
                      {apt.status === "pending" && (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="w-11 h-11 rounded bg-green-50 text-green-600 flex items-center justify-center hover:bg-green-100 transition-colors"
                          ...
                          <button
                            ...
                            className="w-11 h-11 rounded bg-red-50 text-red-600 flex items-center justify-center hover:bg-red-100 transition-colors"
