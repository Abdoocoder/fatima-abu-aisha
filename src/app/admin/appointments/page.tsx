                      ...
                      {apt.status === "pending" && (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="w-11 h-11 rounded bg-green-50 text-green-600 flex items-center justify-center hover:bg-green-100 transition-colors duration-150 ease-[var(--ease-out)] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                          ...
                          <button
                            ...
                            className="w-11 h-11 rounded bg-red-50 text-red-600 flex items-center justify-center hover:bg-red-100 transition-colors duration-150 ease-[var(--ease-out)] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
