        ...
        <div className="max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7 space-y-8">
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="font-tajawal text-xl font-bold text-brand-gold">
                عن المحامية
              </h2>
        ...
        <div className="max-w-container-max mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="font-tajawal text-2xl font-bold text-brand-navy">
                مسيرة مهنية متميزة
              </h4>
      ...
      <section className="py-24 px-margin-mobile md:px-margin-desktop bg-brand-navy text-white relative overflow-hidden">
        ...
        <div className="max-w-container-max mx-auto relative z-10">
          <div className="text-center space-y-4 mb-16">
            <h3 className="font-tajawal text-3xl font-bold text-brand-gold">
              القيم المهنية
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            >
              ...
              <h4 className="font-tajawal text-2xl font-bold">
                النزاهة والشفافية
              </h4>
